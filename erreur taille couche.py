...
import os
os.chdir(r"C:\Users\decroux paul\Documents\info")
...
for i in range(10, 150, 10):
    ...
    net.entrainement(x_train, y_train, iterations=5000, learning_rate=0.001)
...
plt.plot(np.linspace(10,150,14), E0, label='0')
plt.plot(np.linspace(10,150,14), E1, label='1')
plt.plot(np.linspace(10,150,14), E2, label='2')
plt.plot(np.linspace(10,150,14), E3, label='3')
plt.plot(np.linspace(10,150,14), E4, label='4')
plt.plot(np.linspace(10,150,14), E5, label='5')
plt.plot(np.linspace(10,150,14), E6, label='6')
plt.legend()
